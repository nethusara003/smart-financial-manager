...
const DraggableAssistant = () => {
  ...
  return (
    <div
      ...
      className="group fixed bottom-6 right-6 z-[95] flex cursor-grab active:cursor-grabbing items-center gap-3 rounded-[1.75rem] border border-[rgba(255,255,255,0.08)] px-4 py-3 text-left transition-[box-shadow,border-color] duration-200 hover:border-[rgba(59,130,246,0.5)] shadow-2xl"
    >
